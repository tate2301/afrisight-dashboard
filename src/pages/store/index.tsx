...
import { DevicePhoneMobileIcon, Square3Stack3DIcon } from "@heroicons/react/24/outline";
import useWithStatus from "../../hooks/useWithStatus";
import axiosInstance from "@/hooks/useApiFetcher";
import { GAMIFICATION_ROUTES, USER_ROUTES } from "@/lib/api-routes";
import { cn } from "@/lib/utils";
import { BoxesIcon, Building2, CheckIcon, LoaderIcon, Ticket, User2Icon } from "lucide-react";
import {
  Table,
  TableBody,
  TableCell,
      ...
      <Table>
        <TableHeader className='text-start text-sm py-2 border-b'>
          <TableRow>
            ...
            <TableHead>Base price <span className="text-xs">(in points)</span></TableHead>
          ...
          {listings.map((listing) => (
            <TableRow>
              ...
              <TableCell className='capitalize'>
                <p className={cn("w-fit px-2.5 py-1 inline-flex gap-2 font-semibold", listing.type === "virtual_good" && "text-teal-600", listing.type === "voucher" && "text-orange-600")}>
