...
const DifficultySection = ({ formik }: { formik: any }) => (
    <Box>
        ...
        <RadioCards.Root
            ...
            <RadioCards.Item value="easy" className="p-4 rounded-xl bg-surface-secondary text-left">
                <Flex direction="column" className="flex flex-col gap-2">
            ...
            <RadioCards.Item value="hard" className="p-4 rounded-xl bg-surface-secondary text-left">
                <Flex direction="column" className="flex flex-col gap-2">
                    <p className='text-content-tertiary'>
                        <Symbol>
                            star_half
            ...
            <RadioCards.Item value="extreme" className="p-4 rounded-xl bg-surface-secondary text-left">
                <Flex direction="column" className="flex flex-col gap-2">
                    <p className='text-content-tertiary'>
                        <Symbol>
                            hotel_class
