...
import {Avatar, Button, Dialog, Flex, TextField} from '@radix-ui/themes';
	...
	return (
		<Dialog.Root>
			...
			<Dialog.Content maxWidth="450px">
				<Dialog.Title weight={'medium'}>Add Client</Dialog.Title>
				<Dialog.Description
					size="2"
					mb="6">
						...
						<Form>
							...
							<Box className="my-2">
								{addClientMutation.isError && (
									<Caption css={{color: '$danger'}}>
										We encountered a problem: {addClientMutation.error.message}.
										Try again.
									</Caption>
								)}
							</Box>
