		...
		return (
			<CommandItem
				...
				<Flex
					...
					<Caption>{formatDate(item.data.expiresAt)}</Caption>
				</Flex>
			</CommandItem>
		);
	};
	...
	return (
		<Dialog.Root>
			...
			<Dialog.Content maxWidth="450px">
				<Dialog.Title weight={'medium'}>Add reward policy</Dialog.Title>
				<Dialog.Description
					size="2"
					mb="6">
					...
					{({
						...
						<Form>
							...
							<Flex
								...
								<Button
									type="submit"
									disabled={createRewardPolicyMutation.isPending}
									color={'indigo'}>
