...
let button = tv({
	extend: focusRing,
	base: 'px-5 py-1.5 h-[32px] flex items-center gap-2 rounded-lg text-[13px] text-center transition font-bold border border-black/10 dark:border-white/10 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.1)] dark:shadow-none cursor-default',
	variants: {
		variant: {
			...
			outline:
				'border border-transparent pressable-shadow pressed:border-content-tertiary',
